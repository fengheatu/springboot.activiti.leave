...
<head>
    ...
    <script src="../../../js/common/plugins/jui/extends/themeswitcher/jquery.ui.switcher.js" type="text/javascript"></script>
    <script src="../../../js/common/plugins/tools/jquery.cookie.js" type="text/javascript"></script>
	<script src="../../../js/common/plugins/jui/extends/layout/jquery.layout.min.js?v=1.3" type="text/javascript"></script>
	<script src='../../../js/common/common.js' type="text/javascript"></script>
    <script src='../../../js/module/main/main-frame.js' type="text/javascript"></script>
</head>
<body>
<!-- #TopPane -->
<div id="topPane" class="ui-layout-north ui-widget ui-widget-header ui-widget-content">
	<div style="padding-left:5px; font-size: 16px; margin-top: 1px;">
       	<table id="topTable" style="padding: 0px;margin: 0px;margin-top: -5px" width="100%">
       		<tr>
       			<td width="40px">
       				<img src="../../../images/logo.png" height="48" align="top"  style="margin-top:5px" />
       			</td>
       			<td>
       			...
       			<td>
       				<div style="float:right; color: #fff;font-size: 12px;margin-top: 2px">
		        		<div>
							<span><b>${sessionScope.role.roleCnName } / ${sessionScope.user.userName }</b></span>
		        		</div>
